...
if __name__ =='__main__':
    ...
    print("FIRST NEUTROSOPHIC CUBIC SET")
    print()
    Neutrosophic_Cubic_list_1 = eval(input("Enter the Neutrosophic Cubic Set : "))
    print()
    Neutrosophic_Cubic_Set_1 = NCS("A",Neutrosophic_Cubic_list_1)
    print(Neutrosophic_Cubic_Set_1)
    print()

    print("SECOND NEUTROSOPHIC CUBIC SET")
    print()
    Neutrosophic_Cubic_list_2 = eval(input("Enter the Neutrosophic Cubic Set : "))
    print()
    Neutrosophic_Cubic_Set_2 = NCS("B",Neutrosophic_Cubic_list_2)
    print(Neutrosophic_Cubic_Set_2)
    print()

    print("OPERATIONS")
    print()
    print(Neutrosophic_Cubic_Set_1.p_union(Neutrosophic_Cubic_Set_2))
    print()
    print(Neutrosophic_Cubic_Set_1.p_intersection(Neutrosophic_Cubic_Set_2))
    print()
    print(Neutrosophic_Cubic_Set_1.r_union(Neutrosophic_Cubic_Set_2))
    print()
    print(Neutrosophic_Cubic_Set_1.r_intersection(Neutrosophic_Cubic_Set_2))
    print()
    print(Neutrosophic_Cubic_Set_1.complement())
    print()
    print(Neutrosophic_Cubic_Set_2.complement())
    print()
    print("A equal to B : ",Neutrosophic_Cubic_Set_1==Neutrosophic_Cubic_Set_2)
    print()
    print(Neutrosophic_Cubic_Set_1+Neutrosophic_Cubic_Set_2)
    print()
    print(Neutrosophic_Cubic_Set_1*Neutrosophic_Cubic_Set_2)
    print()
    print((Neutrosophic_Cubic_Set_1).scalar_multiplication(2))
    print()
    print((Neutrosophic_Cubic_Set_2).scalar_multiplication(2))
    print()
    print("A containment B : ",Neutrosophic_Cubic_Set_1.containment(Neutrosophic_Cubic_Set_2))
    print()
    print("Score of A : ",Neutrosophic_Cubic_Set_1.score())
    print()
    print("Accuracy of A : ",Neutrosophic_Cubic_Set_1.accuracy())
    print()
    print("Certainty of A : ",Neutrosophic_Cubic_Set_1.certainty())
    print()
    print("Score of B : ",Neutrosophic_Cubic_Set_2.score())
    print()
    print("Accuracy of B : ",Neutrosophic_Cubic_Set_2.accuracy())
    print()
    print("Certainty of B : ",Neutrosophic_Cubic_Set_2.certainty())
'''